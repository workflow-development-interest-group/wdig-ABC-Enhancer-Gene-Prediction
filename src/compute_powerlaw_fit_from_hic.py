...
def parseargs():
    ...
    parser.add_argument('--hic_type', help="Output directory")
    ...
    for chrom in chromosomes:
        try:
            if args.hic_type == 'juicebox':
                ...
                this_data['dist_for_fit'] = abs((this_data['x2'] + this_data['x1'])/2 - (this_data['y2'] + this_data['y1'])/2)
...
#     for chrom in chromosomes:
#         try:
#             hic_file, hic_norm_file, hic_is_vc = get_hic_file(chrom, args.hicDir, allow_vc=False, hic_type='juicebox')
#             print("Working on {}".format(hic_file))
